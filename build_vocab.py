...
def main():
    ...
    parser.add_argument('--corpus_path', '-c', type=str, default='./data/tox21.txt', help='path to th ecorpus')
    parser.add_argument('--out_path', '-o', type=str, default='./data/tox21_vocab.pkl', help='output file')
