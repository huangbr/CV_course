...
_C.DATA.RATE = None
# Random_Num for data enhancement
_C.DATA.RANDOM_NUM = 5
...
_C.TRAIN.LR_SCHEDULER.TYPE = 'cosine'
# _C.TRAIN.LR_SCHEDULER.TYPE = 'reduce'
# NoamLR parameters
_C.TRAIN.LR_SCHEDULER.WARMUP_EPOCHS = 2.0
_C.TRAIN.LR_SCHEDULER.INIT_LR = 5e-4
_C.TRAIN.LR_SCHEDULER.MAX_LR = 1e-3
