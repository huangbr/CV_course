...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='./data/tox21_enhancement.csv', help='input file')
    parser.add_argument('--out_path', '-o', type=str, default='./data/tox21.txt', help='output file')
